...
const UITemplateWebsite = (props: any) => {
  ...
  return (
    <>
      <div className="uh-h-screen from-grad-default-white-from to-grad-default-white-to m-0 bg-gradient-to-b">
        <div className="uh-h-screen divide-y-1.5 mx-auto flex flex-col">
          ...
          <div className="flex flex-1 flex-col overflow-clip bg-[#F0F0F0]">
            {props.children}
          </div>
...
export default UITemplateWebsite;
